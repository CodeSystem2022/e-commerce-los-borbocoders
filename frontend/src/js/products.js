...
export async function onInitProducts() {
  ...
  try {
    // Intentar obtener productos utilizando la función getProducts
    products = await getProducts();
  } catch (error) {
    console.log(error);
  }
  // Limpiar el contenido existente del contenedor de la lista de productos
  productList.innerHTML = "";
  // Iterar a través del array de productos y crear elementos HTML para cada uno
  products.forEach((product) => {
    // Generar la URL de origen de la imagen basada en el ID del producto
    ...
    // Agregar una clase CSS al contenedor div del producto
    productDiv.classList.add("product");

    // Establecer la fuente de la imagen y el atributo para la imagen del producto
    productImg.src = imageSource;
    productImg.setAttribute("s", imageSource);
    // Establecer IDs y contenido para otros detalles del producto
    ...
    // Establecer atributos y contenido para el enlace de acción del producto
    productAction.href = "#";
    ...
    // Adjuntar los elementos creados al contenedor div del producto
    ...
    // Adjuntar el contenedor div del producto al contenedor de la lista de productos
